...
%% preparamos bucle donde todos los datos se abren 
   ...
   while contadorY < contador
       ...
       %DeltaBN4= abs((DeltaBN3(900)- max(DeltaBN3(1:P)))/Am)*1000000; %Obtengo el valor en microvoltios, considero tiempo de aparicion 
       %DeltaBN4= abs(((0- max(DeltaBN3(1:P)))/Am)*1000000); %correcion a cero 
